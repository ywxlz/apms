...
<body>
	...
	<table width="586" border="1">
	      <tr>
	        <td width="123"><div align="center">所属部门（处）</div></td>
	        <td width="168"><label for="dept"></label>
	          <div align="center">
	            <input type="text" name="dept" id="dept" />
	        </div></td>
	        <td width="95"><div align="center">联系电话</div></td>
	        <td width="172"><label for="phone"></label>
	          <div align="center">
	      ...
	      <tr>
	        ...
	        <td><label for="pinyin"></label>
	          <div align="center">
	            <input type="text" name="pinyin" id="pinyin" />
	        </div></td>
	      </tr>
	      <tr>
	        <td height="48" colspan="4"><p align="center">
	          <label>
	      ...
	      <tr>
	        <td height="84"><div align="center">使用期限</div></td>
	      ...
	      <tr>
	        <td height="122"><div align="center">申请（更改）原因</div></td>
