...
<body>
	<div align="center">
	  ...
	  <form id="form1" name="form1" method="post" action="">
		<table width="760" height="353" border="1">
		      <tr>
		        <td width="125"><div align="center">申请人</div></td>
		        <td width="209"><label for="username"></label>
		        <input type="text" name="username" id="username" /></td>
		        <td width="149"><div align="center">部   门</div></td>
		        <td width="249"><label for="dept"></label>
		        <input type="text" name="dept" id="dept" /></td>
		      </tr>
		      <tr>
		        <td><div align="center">申请原因</div></td>
		        <td colspan="3"><label for="reason"></label>
		        <textarea name="reason" id="reason" cols="45" rows="5"></textarea></td>
		      </tr>
		      <tr>
