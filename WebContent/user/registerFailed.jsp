...
<body>
	...
	<div class="header-wrapper">
		...
		<div class="search-area container">
			<br /><br /><br /><br /><br /><br />
			<form id="search-form" class="search-form clearfix" method="post" action="logoutAction" autocomplete="off">
				<font style="font-size: x-large;">
					注册失败，尝试再次
					<a href="register/register.jsp" style="color: blue;text-decoration: underline;">注册</a>.
					<br />
					或者关闭本页面,感谢您的注册!
				</font>
			</form>
